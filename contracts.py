...
class ContractMaker:
    ...
    _CONTRACT_PATH = f'{_COMMON_PATH}contracts/'
    ...
    def defDueDate(self):
        with open(f'{self._COMMON_PATH}dueDate.json', encoding="utf-8") as f:
            data = json.load(f)
    ...
    def defDifficulty(self):
        with open(f'{self._CONTRACT_PATH}difficulty.json', encoding="utf-8") as f:
            data = json.load(f)
    ...
    def defDistance(self):
        with open(f'{self._CONTRACT_PATH}distance.json', encoding="utf-8") as f:
            data = json.load(f)
    ...
    def defValeuReward(self):
        with open(f'{self._CONTRACT_PATH}valueReward.json', encoding="utf-8") as f:
            data = json.load(f)
    ...
    def defPreRequirements(self):
        with open(f'{self._CONTRACT_PATH}preRequirementsClause.json', encoding="utf-8") as f:
            data = json.load(f)
    ...
    def defContractor(self):
        with open(f'{self._CONTRACT_PATH}contractors.json', encoding="utf-8") as f:
            data = json.load(f)
    ...
    def defObjective(self):
        with open(f'{self._CONTRACT_PATH}objectives.json', encoding="utf-8") as f:
    ...
    def defLocation(self):
        with open(f'{self._CONTRACT_PATH}location.json', encoding="utf-8") as f:
            fullData = json.load(f)
        resultJson = json.loads("{}")
    ...
    def defAntagonist(self):
        with open(f'{self._CONTRACT_PATH}antagonist.json', encoding="utf-8") as f:
            fullData = json.load(f)
    ...
    def defComplication(self):
        with open(f'{self._CONTRACT_PATH}complications.json', encoding="utf-8") as f:
            fullData = json.load(f)
        resultJson		 = json.loads("{}")
    ...
    def defAllies(self):
        with open(f'{self._CONTRACT_PATH}allies.json', encoding="utf-8") as f:
            fullData = json.load(f)
        resultJson = json.loads("{}")
    ...
    def defExtraReward(self):
        with open(f'{self._CONTRACT_PATH}rewardsAndIncentives.json', encoding="utf-8") as f:
            fullData = json.load(f)
        resultJson = json.loads("{}")
    ...
    def defTurnaround(self):
        with open(f'{self._CONTRACT_PATH}turnarounds.json', encoding="utf-8") as f:
            fullData = json.load(f)
        resultJson = json.loads("{}")
    ...
    def defKeyWords(self):
        with open(f'{self._CONTRACT_PATH}keywordsContract.json', encoding="utf-8") as f:
            fullData = json.load(f)
        resultJson = json.loads("{}")
    ...
    def defBiluteteia(self):
        with open(f'{self._CONTRACT_PATH}unusualContractors.json', encoding="utf-8") as f:
            fullData = json.load(f)
        resultJson = json.loads("{}")
    ...
    def defKeyWordsContractors(self):
        with open(f'{self._CONTRACT_PATH}keywordContractor.json', encoding="utf-8") as f:
            fullData = json.load(f)
        resultJson = json.loads("{}")
    ...
    def defVillain(self):
        ...
        resultJson['exist'] = self.contratJson["contractType"]["villainNeed"]
        if resultJson['exist']:
            self.contratJson['villains'] = resultJson
        
        #with open(f'{self._CONTRACT_PATH}villians.json', encoding="utf-8") as f:
        #    data = json.load(f)
